...
class _HistoriaLongText extends StatelessWidget {
  const _HistoriaLongText();
  ...
  Widget build(BuildContext context) {
    return const Text(
      ...
      'Em 1953, é publicada a Recomendação nº 97 da OIT sobre “Proteção da Saúde dos Trabalhadores”. Em 1956, o governo brasileiro aprova por Decreto Legislativo a Convenção nº 81 – Fiscalização do Trabalho, da OIT.\n\n'
