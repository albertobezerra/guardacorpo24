...
import 'package:guarda_corpo_2024/theme/app_theme.dart'; // Importante para cores
...
class AcidenteRaiz extends StatelessWidget {
        ...
        children: [
          FutureBuilder<Map<String, dynamic>>(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                children: [
                  // --- BOTÃO 1: CONTEÚDO COMUM (Sobre Acidentes) ---
                  _buildLargeListTile(
                    context,
                    label: 'Sobre Acidentes',
                  ...
                  // --- BOTÃO 2: CONTEÚDO PREMIUM (Calculadora) ---
                  _buildLargeListTile(
                    context,
                    label: 'Calculadora de Custo',
                    icon: Icons.calculate_outlined,
                    color: AppTheme.primaryColor,
                    isPremium: true, // Visual dourado automático
                    onTap: () {
                      if (isPremium) {
                        // Usuário TEM acesso
                        Navigator.push(
                        ...
                        // Usuário NÃO tem acesso -> Dialog de Venda
  ...
  // === MÉTODOS VISUAIS IDÊNTICOS À SAFETY LIST ===
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const PremiumPage()) // Navega para a venda
                    );
              },
